    ...
    <ul class="we-comet">
      <li v-for="(item, index) in commentList" :key="index">
        <div class="comet-avatar">
          <img
            src="https://molu-s3.s3.ap-northeast-1.amazonaws.com/images/admin.png"
            alt=""
          />
        </div>
      ...
      <li class="post-comment">
        ...
        <div class="post-comt-box">
          ...
          ></textarea>
          <div @click="addComment" class="add-smiles">
...
export default {
  ...
  mounted() {
    this.commentList = this.feed.comments;
  },
  methods: {
